...
def classify_venue(categories: list) -> tuple[str, list[str], list[str]]:
    ...
    cuisine_translation = {
        ...
        "新疆菜": "xinjiang",
        # DUPLICATE: "雲南菜": "yunnan",
        # DUPLICATE: "潮州菜": "teochew",
        # DUPLICATE: "客家菜": "hakka",
        # DUPLICATE: "北京菜": "beijing",
        # DUPLICATE: "星馬菜": "malaysian",
        ...
        "葡國菜": "portuguese",
        "澳洲菜": "australian",
        # DUPLICATE: "英國菜": "british",
        # DUPLICATE: "俄羅斯菜": "russian",
        # Latin America
        "阿根廷菜": "argentinian",
        "巴西菜": "brazilian",
        "秘魯菜": "peruvian",
        # DUPLICATE: "墨西哥菜": "mexican",
        # Other
        # DUPLICATE: "蒙古菜": "mongolian",
        "尼泊爾菜": "nepalese",
        "fusion菜": "fusion",
